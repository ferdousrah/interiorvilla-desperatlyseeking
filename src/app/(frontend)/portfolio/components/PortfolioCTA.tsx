    ...
    <section className="w-full py-10 sm:py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#01190c] mb-6 sm:mb-8 relative z-10">
            Ready to transform your space?
          </h2>

          <Link
            href="/book-appointment"
            className="inline-block bg-secondary hover:bg-secondary/90 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full text-sm sm:text-base md:text-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg relative z-10"
          >
            Book an Appointment
          </Link>
        </motion.div>
