...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "projects_before_after_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer
  ...
  CREATE TABLE "projects_gallery_photos" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer
  ...
  CREATE TABLE "projects_gallery_videos" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"video_url" varchar
  ...
  CREATE TABLE "projects_gallery_plans" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer
  ...
  CREATE TABLE "projects" (
  	...
  	"is_architectural" boolean DEFAULT false,
  	"position" numeric,
  ...
  CREATE TABLE "services_our_approach_approaches" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "services" (
  	...
  	"recent_projects_section_description" varchar,
  	"seo_details_meta_title" varchar,
  	"seo_details_meta_description" varchar,
  	"seo_details_meta_key" varchar,
  	"seo_details_og_image_id" integer,
  ...
  CREATE TABLE "home_about_section_before_after_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer
  ...
  CREATE TABLE "home_about_section_highlights" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar,
  ...
  CREATE TABLE "home_our_process_steps" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon_id" integer,
  ...
  CREATE TABLE "home" (
  	...
  	"featured_works_section_description" varchar,
  	"featured_works_background_color" varchar,
  	"about_section_section_title" varchar,
  	"about_section_short_description" varchar,
  	"about_section_background_color" varchar,
  	"services_section_section_title" varchar,
  	"services_section_short_description" varchar,
  	"services_section_background_color" varchar,
  	"our_process_section_title" varchar,
  	"our_process_short_description" varchar,
  	"our_process_background_color" varchar,
  	"client_stories_section_title" varchar,
  	"client_stories_short_description" varchar,
  	"client_stories_background_color" varchar,
  	"google_reviews_section_title" varchar DEFAULT 'Google Reviews',
  	"google_reviews_short_description" varchar DEFAULT 'See what our clients say about us on Google',
  	"google_reviews_overall_rating" numeric,
  ...
  CREATE TABLE "about_intro_section_stats" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "about_our_approach_approaches" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon_id" integer,
  ...
  CREATE TABLE "about" (
  	...
  	"intro_section_intro_video" varchar,
  	"our_approach_section_title" varchar,
  	"our_approach_description" varchar,
  	"mission_vision_section_title" varchar,
  	"mission_vision_description" varchar,
  	"mission_vision_mission_content" jsonb,
  	"mission_vision_vision_content" jsonb,
  	"team_section_section_title" varchar,
  	"team_section_description" varchar,
  	"seo_details_meta_title" varchar,
  	"seo_details_meta_description" varchar,
  	"seo_details_meta_key" varchar,
  	"seo_details_seo_structured_data" varchar,
  ...
  ALTER TABLE "projects_before_after_images" ADD CONSTRAINT "projects_before_after_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "projects_before_after_images" ADD CONSTRAINT "projects_before_after_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "projects_gallery_photos" ADD CONSTRAINT "projects_gallery_photos_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "projects_gallery_photos" ADD CONSTRAINT "projects_gallery_photos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "projects_gallery_videos" ADD CONSTRAINT "projects_gallery_videos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "home_about_section_before_after_images" ADD CONSTRAINT "home_about_section_before_after_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "home_about_section_before_after_images" ADD CONSTRAINT "home_about_section_before_after_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "blog" ADD CONSTRAINT "blog_hero_hero_image_id_media_id_fk" FOREIGN KEY ("hero_hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "about_intro_section_stats" ADD CONSTRAINT "about_intro_section_stats_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_our_approach_approaches" ADD CONSTRAINT "about_our_approach_approaches_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "about_our_approach_approaches" ADD CONSTRAINT "about_our_approach_approaches_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about" ADD CONSTRAINT "about_hero_hero_image_id_media_id_fk" FOREIGN KEY ("hero_hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "about_rels" ADD CONSTRAINT "about_rels_team_members_fk" FOREIGN KEY ("team_members_id") REFERENCES "public"."team_members"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "portfolio" ADD CONSTRAINT "portfolio_hero_hero_image_id_media_id_fk" FOREIGN KEY ("hero_hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "projects_before_after_images_order_idx" ON "projects_before_after_images" USING btree ("_order");
  CREATE INDEX "projects_before_after_images_parent_id_idx" ON "projects_before_after_images" USING btree ("_parent_id");
  CREATE INDEX "projects_before_after_images_image_idx" ON "projects_before_after_images" USING btree ("image_id");
  CREATE INDEX "projects_gallery_photos_order_idx" ON "projects_gallery_photos" USING btree ("_order");
  CREATE INDEX "projects_gallery_photos_parent_id_idx" ON "projects_gallery_photos" USING btree ("_parent_id");
  CREATE INDEX "projects_gallery_photos_image_idx" ON "projects_gallery_photos" USING btree ("image_id");
  CREATE INDEX "projects_gallery_videos_order_idx" ON "projects_gallery_videos" USING btree ("_order");
  CREATE INDEX "projects_gallery_videos_parent_id_idx" ON "projects_gallery_videos" USING btree ("_parent_id");
  CREATE INDEX "projects_gallery_plans_order_idx" ON "projects_gallery_plans" USING btree ("_order");
  ...
  CREATE INDEX "services_our_approach_approaches_order_idx" ON "services_our_approach_approaches" USING btree ("_order");
  ...
  CREATE INDEX "slider_slider_slider_image_idx" ON "slider" USING btree ("slider_image_id");
  ...
  CREATE INDEX "home_about_section_before_after_images_order_idx" ON "home_about_section_before_after_images" USING btree ("_order");
  CREATE INDEX "home_about_section_before_after_images_parent_id_idx" ON "home_about_section_before_after_images" USING btree ("_parent_id");
  CREATE INDEX "home_about_section_before_after_images_image_idx" ON "home_about_section_before_after_images" USING btree ("image_id");
  CREATE INDEX "home_about_section_highlights_order_idx" ON "home_about_section_highlights" USING btree ("_order");
  CREATE INDEX "home_about_section_highlights_parent_id_idx" ON "home_about_section_highlights" USING btree ("_parent_id");
  ...
  CREATE INDEX "blog_hero_hero_hero_image_idx" ON "blog" USING btree ("hero_hero_image_id");
  CREATE INDEX "about_intro_section_stats_order_idx" ON "about_intro_section_stats" USING btree ("_order");
  CREATE INDEX "about_intro_section_stats_parent_id_idx" ON "about_intro_section_stats" USING btree ("_parent_id");
  CREATE INDEX "about_our_approach_approaches_order_idx" ON "about_our_approach_approaches" USING btree ("_order");
  CREATE INDEX "about_our_approach_approaches_parent_id_idx" ON "about_our_approach_approaches" USING btree ("_parent_id");
  CREATE INDEX "about_our_approach_approaches_icon_idx" ON "about_our_approach_approaches" USING btree ("icon_id");
  CREATE INDEX "about_hero_hero_hero_image_idx" ON "about" USING btree ("hero_hero_image_id");
  ...
  CREATE INDEX "about_rels_team_members_id_idx" ON "about_rels" USING btree ("team_members_id");
  CREATE INDEX "portfolio_hero_hero_hero_image_idx" ON "portfolio" USING btree ("hero_hero_image_id");
  CREATE INDEX "contact_hero_hero_hero_image_idx" ON "contact" USING btree ("hero_hero_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "projects_before_after_images" CASCADE;
  DROP TABLE "projects_gallery_photos" CASCADE;
  DROP TABLE "projects_gallery_videos" CASCADE;
  DROP TABLE "projects_gallery_plans" CASCADE;
  DROP TABLE "projects" CASCADE;
  DROP TABLE "project_categories" CASCADE;
  DROP TABLE "services_our_approach_approaches" CASCADE;
  ...
  DROP TABLE "about_intro_section_stats" CASCADE;
  DROP TABLE "about_our_approach_approaches" CASCADE;
